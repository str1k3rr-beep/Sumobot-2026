...
#   - Calibración automática del piso negro, 0.5 s después de encender
...
#
# IMPORTANTE para que el robot arranque solo al encender (sin Thonny
# conectado): este archivo debe llamarse "code.py" y estar en la raíz
# de la unidad CIRCUITPY. Además, deben existir en la carpeta /lib de
# esa misma unidad: ideaboard.py (o .mpy) y hcsr04.py (o .mpy).
# ==========================================
...
DURACION_CALIB = 2.0   # segundos que se muestrea el piso negro durante la calibración
...
PAUSA_ARRANQUE = 0.5   # segundos de pausa antes de calibrar, sin esperar botón
...
while True:
    ...
    # -------- 1. Pausa de arranque (medio segundo, sin botón) --------
