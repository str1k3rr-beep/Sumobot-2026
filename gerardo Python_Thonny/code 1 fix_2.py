...
# ============================================================
# ARRANQUE SUAVE — evita pico de corriente en baterías AA
# ============================================================

def arrancar_motores(m1, m2, pasos=4):
    """Sube throttle gradualmente para no colapsar el voltaje de las AA."""
    for i in range(1, pasos + 1):
        ib.motor_1.throttle = m1 * (i / pasos)
        ib.motor_2.throttle = m2 * (i / pasos)
        sleep(0.008)
...
def maniobra_escape(direccion):
    ...
    # Retroceso base con arranque suave
