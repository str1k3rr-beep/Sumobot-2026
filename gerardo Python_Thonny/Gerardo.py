...
def maniobra_escape(direccion):
    ...
    # Fase 1: giro inicial para alejarse del borde
    ...
    while time.monotonic() - start < 0.15:
        ...
        if rival_detectado():
            # Rival detectado durante el giro → atacar de inmediato
            _rival_perdido_count = 0
            ib.pixel = (0, 255, 0)
            ib.motor_1.throttle = -1.0
            ib.motor_2.throttle = 1.0
    ...
    # Fase 2: retroceso / reposicionamiento según dirección del borde
